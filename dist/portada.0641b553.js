...
requestAnimationFrame(raf);
let container = document.querySelector(".slides"), slides = (0, _gsap.gsap).utils.toArray(".slide"), getRatio = (el)=>window.innerHeight / (window.innerHeight + el.offsetHeight);
slides.forEach((slide, i)=>{
    let bg = slide.querySelector("img"), content = slide.querySelector("h3"), tl = (0, _gsap.gsap).timeline({
        scrollTrigger: {
            trigger: slide,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gbXMy","bNKaB"], "bNKaB", "parcelRequireba3a")
